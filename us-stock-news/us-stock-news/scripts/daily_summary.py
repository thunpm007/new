...
4. ส่งเข้า Claude API เพื่อสรุปเป็นภาษาไทย แบบมีโครงสร้าง
...
def summarize_with_claude(articles: list[dict]) -> dict:
    ...
    resp = client.messages.create(
        ...
        messages=[{"role": "user", "content": f"ข่าววันนี้:\n\n{numbered}"}],
    )
...
def main():
    ...
    print("กำลังส่งเข้า Claude เพื่อสรุป...")
    summary = summarize_with_claude(fresh)
